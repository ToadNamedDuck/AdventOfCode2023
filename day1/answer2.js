...
//Now we need to do something similar to the first thing, except also extract out written numbers.
const splitInput = input.split("\n");
//We only need to check the first and last "Digits" of the problem.

//Get the first digit
const x = splitInput.map(line => {
    let firstDigit = null;
    let lastDigit = null;
    ...
    let lineCopy = line;
    while (true) {
        if (lineCopy.substring(0, 3) === "one" || lineCopy.substring(0, 1) === "1") {
            firstDigit = 1;
        }
        if (lineCopy.substring(0, 3) === "two" || lineCopy.substring(0, 1) === "2") {
            firstDigit = 2;
        }
        if (lineCopy.substring(0, 5) === "three" || lineCopy.substring(0, 1) === "3") {
            firstDigit = 3;
        }
        if (lineCopy.substring(0, 4) === "four" || lineCopy.substring(0, 1) === "4") {
            firstDigit = 4;
        }
        if (lineCopy.substring(0, 4) === "five" || lineCopy.substring(0, 1) === "5") {
            firstDigit = 5;
        }
        if (lineCopy.substring(0, 3) === "six" || lineCopy.substring(0, 1) === "6") {
            firstDigit = 6;
        }
        if (lineCopy.substring(0, 5) === "seven" || lineCopy.substring(0, 1) === "7") {
            firstDigit = 7;
        }
        if (lineCopy.substring(0, 5) === "eight" || lineCopy.substring(0, 1) === "8") {
            firstDigit = 8;
        }
        if (lineCopy.substring(0, 4) === "nine" || lineCopy.substring(0, 1) === "9") {
            firstDigit = 9;
        }
        if (lineCopy.substring(0, 4) === "zero" || lineCopy.substring(0, 1) === "0") {
            firstDigit = 0;
        }
    ...
    //Get the last digit.
    while (true) {
        if(lineCopy.substring(lineCopy.length - 3, lineCopy.length) === "one" || lineCopy.substring(lineCopy.length - 1) === "1"){
            lastDigit = 1;
        }
        if(lineCopy.substring(lineCopy.length - 3, lineCopy.length) === "two" || lineCopy.substring(lineCopy.length - 1) === "2"){
            lastDigit = 2;
        }
        if(lineCopy.substring(lineCopy.length - 5, lineCopy.length) === "three" || lineCopy.substring(lineCopy.length - 1) === "3"){
            lastDigit = 3;
        }
        if(lineCopy.substring(lineCopy.length - 4, lineCopy.length) === "four" || lineCopy.substring(lineCopy.length - 1) === "4"){
            lastDigit = 4;
        }
        if(lineCopy.substring(lineCopy.length - 4, lineCopy.length) === "five" || lineCopy.substring(lineCopy.length - 1) === "5"){
            lastDigit = 5;
        }
        if(lineCopy.substring(lineCopy.length - 3, lineCopy.length) === "six" || lineCopy.substring(lineCopy.length - 1) === "6"){
            lastDigit = 6;
        }
        if(lineCopy.substring(lineCopy.length - 5, lineCopy.length) === "seven" || lineCopy.substring(lineCopy.length - 1) === "7"){
            lastDigit = 7;
        }
        if(lineCopy.substring(lineCopy.length - 5, lineCopy.length) === "eight" || lineCopy.substring(lineCopy.length - 1) === "8"){
            lastDigit = 8;
        }
        if(lineCopy.substring(lineCopy.length - 4, lineCopy.length) === "nine" || lineCopy.substring(lineCopy.length - 1) === "9"){
            lastDigit = 9;
        }
        if(lineCopy.substring(lineCopy.length - 4, lineCopy.length) === "zero" || lineCopy.substring(lineCopy.length - 1) === "0"){
            lastDigit = 0;
        }
        if (lastDigit !== null) {
            result += lastDigit;
...
console.log(x.reduce((acc, cur) => acc += cur))